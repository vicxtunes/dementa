...
import type { MatchQuestion } from "./match-runner";
...
export function EventRunner({
  ...
  function next() {
    ...
    startTransition(async () => {
      ...
      await fetch("/api/challenge-entries", {
        ...
        body: JSON.stringify({ challengeId, answers: finalAnswers }),
      });
  ...
  return (
    <div className="card">
      ...
      >
        {index + 1 < questions.length ? "Next" : pending ? "Submitting…" : "Submit entry"}
